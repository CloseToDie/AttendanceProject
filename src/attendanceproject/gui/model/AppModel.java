...
public class AppModel
{
    ...
    private  ArrayList<Student> getStudentMockData()
    {
        ...
        students.add(new Student(0, "kel44f", "Kelly Branson", "44 Danson street", "4678", "Seattle", "KellyBranson@gmail.com"));
        students.add(new Student(1, "jon56e", "John Bine", "66 Opera street", "5678", "Las Vegas", "JohnBine@gmail.com"));
        students.add(new Student(2, "Jep30f", "Jeppe Stragsgaard", "Debelvej 23 ", "8873", "Ribe", "JeppeStragsgaard@gmail.dk"));
        students.add(new Student(3, "Cal44m", "Cal Elmerson", "89 Forsythe road", "6758", "New York", "CalElmerson@gmail.com"));
        students.add(new Student(4, "Ur88j", "Ursula Vern", "89 Caligula street", "5589", "Chicago", "UrsulaVern@gmail.com"));
        return students;
    }
    
    private  ArrayList<Klasse> getClassMockData(int ver)
    {
        int version = ver;
